defmodule BirdfedWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BirdfedWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BirdfedWeb.Gettext, "errors", msg, opts)
    end
  end
